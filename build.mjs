...
const [html, css, javascript, socialImage, favicon] = await Promise.all([
  ...
  readFile(new URL("images/bikecream-wordmark-social.png", root)),
...
const binaryAssets = new Map([
  ["/images/bikecream-wordmark-social.png", { base64: ${JSON.stringify(socialImage.toString("base64"))}, type: "image/png" }],
